...
var EmptySpaceWrapper = _styledComponents2.default.div(_templateObject, function (props) {
  ...
  return props.width && (0, _styledComponents.css)(_templateObject3, width.includes('px') || width.includes('vw') ? width : width + 'px');
}, _media2.default.phone(_templateObject4, function (props) {
  var mWidth = props.mWidth + '';
  return (props.mWidth || props.mWidth == 0) && (0, _styledComponents.css)(_templateObject5, mWidth.includes('px') || mWidth.includes('vw') ? mWidth : mWidth + 'px');
}));
